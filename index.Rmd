...
#-------------------- Colores ---------------------
color_positivos <- 'lightcoral'
color_activos <- 'gold'
color_recuperados <- 'chartreuse'
color_fallecidos <- 'darkorchid'
color_nuevos_positivos <- 'aquamarine'
color_hospitalizados <- 'aquamarine'
color_salon <- 'aquamarine'
color_uci <- 'aquamarine'
#--------------------- Íconos ---------------------
icono_positivos <- 'ion-man'
icono_activos <- 'fas fa-diagnoses'
icono_recuperados <- 'far fa-smile-wink'
icono_fallecidos <- 'fas fa-skull'
icono_hospitalizados <- 'fas fa-ambulance'
icono_salon <- 'fas fa-hospital'
icono_uci <- 'fas fa-hospital'
#--------------- Otros parámetros -----------------
# Separador para lectura de datos CSV
caracter_separador <- ','
#--------------- Archivos de datos ----------------
archivo_general_pais <- 'https://raw.githubusercontent.com/axell-2930/Datos-Tarea-2/master/07_14_CSV_GENERAL.csv'
archivo_positivos_cantones <- 'https://raw.githubusercontent.com/axell-2930/Datos-Tarea-2/master/07_14_CSV_POSITIVOS.csv'
archivo_activos_cantones <- 'https://raw.githubusercontent.com/axell-2930/Datos-Tarea-2/master/07_14_CSV_ACTIVOS.csv'
archivo_recuperados_cantones <- 'https://raw.githubusercontent.com/axell-2930/Datos-Tarea-2/master/07_14_CSV_RECUP.csv'
archivo_fallecidos_cantones <- 'https://raw.githubusercontent.com/axell-2930/Datos-Tarea-2/master/07_14_CSV_FALLECIDOS.csv'
#---------------------- Datos ---------------------
...
# Data frame de fallecidos por cantón
...
# Data frame de fallecidos por cantón en la última fecha
...
# Objeto sf de fallecidos en cantones en la última fecha
...
centrodedistritos <- st_centroid(sf_distritos)
sf_centrodedistritos_ultima_fecha <-
  left_join( centrodedistritos, df_general_distritos_ultima_fecha, centrodedistritos, by = c('distrito'))  %>%
  arrange(desc(activos))
```
...
Row {data-height=10}
-----------------------------------------------------------------------
### **Última actualización de datos realizada el `r  df_general_pais_ultima_fecha$FECHA` con base en los [datos publicados por el Ministerio de Salud de Costa Rica](http://geovision.uned.ac.cr/oges/). Por Marget Martínez y Axell S. Martínez**.
...
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$positivos, big.mark = ","),caption = "(+446)", "", sep = " "), 
...
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$activos, big.mark = ","), caption = "(+304)", " (",
...
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$RECUPERADOS, big.mark = ","), caption = "(+137)", " (",
...
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$fallecidos, big.mark = ","),caption = "(+5)", " (",
...
Row {data-height=1}
-----------------------------------------------------------------------
### **Última actualización de datos: `r  df_general_pais_ultima_fecha$FECHA`. Por Marget Martínez y Axell S. Martínez**
...
```{r}
paleta_azul <- colorBin(palette = "Reds", 
...
### Mapa de casos activos por canton
...
```{r}
paleta_azul <- colorBin(palette = "YlGn", 
...
### Mapa de casos fallecidos por canton
```{r}
paleta_azul <- colorBin(palette = "Purples", 
...
leaflet() %>%
  fitBounds(lng1 = -86, lng2 = -82, lat1 = 8, lat2 = 11) %>%
  addProviderTiles(providers$OpenStreetMap.Mapnik, group = "OpenStreetMap") %>%
  addHeatmap(data = sf_centrodedistritos_ultima_fecha, 
             intensity= sf_centrodedistritos_ultima_fecha$activos,
